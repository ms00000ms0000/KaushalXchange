...
class Module6Java : Fragment() {
    ...
    private val questions = listOf(
        Question("Which principle of OOP allows using the same method name with different parameters?", listOf("Encapsulation", "Polymorphism", "Abstraction", "Inheritance"), 1),
        Question("Which OOP concept hides the internal details and shows only essential features?", listOf("Encapsulation", "Polymorphism", "Abstraction", "Inheritance"), 2),
        Question("Which OOP concept allows a class to acquire properties of another class?", listOf("Encapsulation", "Abstraction", "Inheritance", "Polymorphism"), 2),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module6_java, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        startAssignmentBtn.setOnClickListener {
            startActivity(Intent(requireContext(), AssessmentActivityJava::class.java))
        }
    }

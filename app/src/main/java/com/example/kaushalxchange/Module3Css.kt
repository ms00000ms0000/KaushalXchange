...
class Module3Css : Fragment() {
    ...
    private val questions = listOf(
        Question("Which CSS property is used to change the text color", listOf("font color", "text style", "color", "background"), 2),
        Question("Which unit is commonly used for font size in responsive design", listOf("px", "pt", "em", "inch"), 2),
        Question("Which CSS property is used to apply shadow effects to elements", listOf("box shadow", "text decorate", "border radius", "transform"), 0),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module3_css, container, false)
    }

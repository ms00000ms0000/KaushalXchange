...
class Module6Html : Fragment() {
    ...
    private val questions = listOf(
        Question("Which HTML5 element is used for drawing graphics using JavaScript", listOf("svg", "canvas", "img", "graphic"), 1),
        Question("Which HTML5 feature allows data to be stored in the browser", listOf("cookies", "local storage", "session storage", "server database"), 1),
        Question("Which tag is used in HTML5 to embed scalable vector graphics", listOf("svg", "canvas", "vector", "shape"), 0),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module6_html, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        startAssignmentBtn.setOnClickListener {
            startActivity(Intent(requireContext(), AssessmentActivityHtml::class.java))
        }
    }

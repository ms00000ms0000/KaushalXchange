...
class Module1Css : Fragment() {
    ...
    private val questions = listOf(
        Question("Which CSS selector is used to style a unique element with a specific id", listOf("class selector", "id selector", "element selector", "group selector"), 1),
        Question("Which type of CSS is defined inside a style tag in the head section", listOf("inline CSS", "external CSS", "internal CSS", "embedded CSS file"), 2),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module1_css, container, false)
    }

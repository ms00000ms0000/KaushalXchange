...
class Module4Java : Fragment() {
    ...
    private val questions = listOf(
        Question("Which control statement is used to exit a loop early in Java?", listOf("exit", "break", "stop", "end"), 1),
        Question("Which control statement is used to skip the current iteration in Java?", listOf("skip", "continue", "break", "pass"), 1),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module4_java, container, false)
    }

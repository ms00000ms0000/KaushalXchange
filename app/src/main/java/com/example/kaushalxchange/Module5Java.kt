...
class Module5Java : Fragment() {
    ...
    private val questions = listOf(
        Question("Which keyword is used to define a method in Java?", listOf("function", "def", "method", "void"), 3),
        Question("What is the purpose of a constructor in Java?", listOf("To destroy an object", "To initialize an object", "To call a method", "To return a value"), 1),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module5_java, container, false)
    }

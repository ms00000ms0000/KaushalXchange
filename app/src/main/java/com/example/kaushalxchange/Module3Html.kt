...
class Module3Html : Fragment() {
    ...
    private val questions = listOf(
        Question("Which attribute of the anchor tag defines the destination link", listOf("src", "href", "alt", "link"), 1),
        Question("Which attribute of the image tag provides alternate text for accessibility", listOf("title", "alt", "name", "desc"), 1),
        Question("Which tag is used to open a hyperlink in a new browser tab", listOf("target", "href", "link", "newtab"), 0),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module3_html, container, false)
    }

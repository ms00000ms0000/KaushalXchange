...
class Module5Css : Fragment() {
    ...
    private val questions = listOf(
        Question("Which Tailwind class creates a layout with three equal columns in grid", listOf("grid cols 2", "grid cols 3", "grid 3", "grid layout"), 1),
        Question("Which Tailwind class is used to align items to the center in flexbox", listOf("justify center", "items middle", "align center", "items center"), 3),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module5_css, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        submitButton.setOnClickListener {
            ...
            Toast.makeText(requireContext(), "Module 5 score: $score / ${questions.size}", Toast.LENGTH_LONG).show()
            prefs.edit().putBoolean("module_5_completed", true).apply()
        }
    }

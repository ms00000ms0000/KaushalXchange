...
class Module1JS : Fragment() {
    ...
    private val questions = listOf(
        Question("Which keyword declares a variable with block scope in JavaScript?", listOf("var", "let", "const", "both let and const"), 4),
        Question("What will be the result of '5' + 2 in JavaScript?", listOf("7", "52", "Error", "Undefined"), 2),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module1_js, container, false)
    }

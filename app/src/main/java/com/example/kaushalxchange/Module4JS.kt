...
class Module4JS : Fragment() {
    ...
    private val questions = listOf(
        Question("Which feature allows JavaScript to handle asynchronous tasks without blocking execution?", listOf("Event loop", "Compiler", "Interpreter", "Garbage collector"), 1),
        Question("Which syntax makes asynchronous code look synchronous in JavaScript?", listOf("Callback", "Promise", "Async Await", "Generator"), 3),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module4_js, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nextButton.setOnClickListener {
            ...
            currentQuestionIndex++; showQuestion(); feedbackText.text = ""
        }
        ...
        submitButton.setOnClickListener {
            ...
            for (i in 0 until optionsGroup.childCount) {
                ...
                if (i == correct) {
                    rb.setBackgroundResource(R.drawable.mcq_correct_background); rb.setTextColor(Color.WHITE)
                } else if (i == selected) {
                    rb.setBackgroundResource(R.drawable.mcq_wrong_background); rb.setTextColor(Color.WHITE)
            ...
            Toast.makeText(requireContext(), "Module 4 score: $score / ${questions.size}", Toast.LENGTH_LONG).show()
            prefs.edit().putBoolean("module_4_completed", true).apply()
        }
    }

...
class Module1Java : Fragment() {
    ...
    private val questions = listOf(
        Question("What is the size of int in Java?", listOf("2 bytes", "4 bytes", "8 bytes", "16 bytes"), 2),
        Question("Which type is used to store text in Java?", listOf("int", "double", "String", "boolean"), 3),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module1_java, container, false)
    }

...
class Module5Html : Fragment() {
    ...
    private val questions = listOf(
        Question("Which tag is used to embed a video file in HTML", listOf("audio", "video", "media", "movie"), 1),
        Question("Which semantic element is used to define navigation links", listOf("nav", "header", "footer", "article"), 0),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module5_html, container, false)
    }

...
class Module4Css : Fragment() {
    ...
    private val questions = listOf(
        Question("Which of the following is a utility class in Tailwind CSS to make text bold", listOf("bold text", "font bold", "text strong", "weight bold"), 1),
        Question("Which Tailwind CSS class is used to center text", listOf("text left", "align center", "text center", "font center"), 2),
        )
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module4_css, container, false)
    }

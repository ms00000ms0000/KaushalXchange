...
class Module4Html : Fragment() {
    ...
    private val questions = listOf(
        Question("Which tag is used to create a row in an HTML table", listOf("td", "tr", "th", "row"), 1),
        Question("Which attribute of the form element defines how form data is sent", listOf("method", "action", "input", "target"), 0),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module4_html, container, false)
    }

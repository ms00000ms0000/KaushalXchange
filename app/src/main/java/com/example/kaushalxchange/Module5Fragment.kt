...
class Module5Fragment : Fragment() {
    ...
    private val questions = listOf(
        Question("Which method in Python classes is used as a constructor?",
            listOf("__start__", "__init__", "__construct__", "__main__"), 1),

        Question("Which OOP principle allows a class to inherit properties and methods from another class?",
            listOf("Encapsulation", "Inheritance", "Polymorphism", "Abstraction"), 1)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module5_fragment, container, false)
    }

...
class Module3JS : Fragment() {
    ...
    private val questions = listOf(
        Question("Which array method is used to transform each element and return a new array?", listOf("map", "filter", "reduce", "forEach"), 1),
        Question("What does the spread operator (...) do in JavaScript?", listOf("Iterates over an array", "Expands elements of arrays or objects", "Concatenates strings", "Creates a shallow copy of function"), 2),
        Question("What is the main issue with shallow copy of objects?", listOf("Consumes more memory", "Does not copy nested objects", "Slower execution", "Cannot copy primitive values"), 2),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module3_js, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        submitButton.setOnClickListener {
            ...
            Toast.makeText(requireContext(), "Module 3 score: $score / ${questions.size}", Toast.LENGTH_LONG).show()
            prefs.edit().putBoolean("module_3_completed", true).apply()
        }
    }

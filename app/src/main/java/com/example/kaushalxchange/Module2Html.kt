...
class Module2Html : Fragment() {
    ...
    private val questions = listOf(
        Question("Which tag is used to create a paragraph in HTML", listOf("para", "paragraph", "p", "text"), 2),
        Question("Which type of list shows items with numbers in HTML", listOf("unordered list", "ordered list", "definition list", "styled list"), 1),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module2_html, container, false)
    }

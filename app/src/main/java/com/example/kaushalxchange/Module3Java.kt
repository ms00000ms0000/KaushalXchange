...
class Module3Java : Fragment() {
    ...
    private val questions = listOf(
        Question("Which data type is used to store whole numbers in Java?", listOf("int", "float", "boolean", "char"), 0),
        Question("Which data type is used to store true or false values in Java?", listOf("int", "boolean", "double", "String"), 1),
        Question("Which data type is used to store single characters in Java?", listOf("char", "String", "byte", "short"), 0),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module3_java, container, false)
    }

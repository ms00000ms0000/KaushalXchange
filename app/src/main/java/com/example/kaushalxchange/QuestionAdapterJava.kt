...
class QuestionAdapterJava(
    private val questionList: List<Question>,
    private val userAnswers: IntArray,
    private val isSubmitted: () -> Boolean // <-- added function reference
) : RecyclerView.Adapter<QuestionAdapterJava.QuestionViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuestionViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.assessment_questions_java, parent, false)

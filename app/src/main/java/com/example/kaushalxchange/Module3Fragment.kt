...
class Module3Fragment : Fragment() {
    ...
    private val questions = listOf(
        Question("Which statement is used in Python to check multiple conditions sequentially?",
            listOf("if-else", "switch", "elif", "match"), 2),

        Question("Which keyword is used to exit a loop immediately in Python?",
            listOf("stop", "exit", "break", "continue"), 2)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module3_fragment, container, false)
    }

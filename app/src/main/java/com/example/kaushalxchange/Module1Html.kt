...
class Module1Html : Fragment() {
    ...
    private val questions = listOf(
        Question("What does HTML stand for", listOf("Hyperlinks and Text Markup Language", "Hyper Text Markup Language", "Home Tool Markup Language", "Hyperlink Tool Management Language"), 1),
        Question("Which tag is used to define the main content visible in a webpage", listOf("head", "body", "title", "meta"), 1),
        )
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module1_html, container, false)
    }

...
class Module2JS : Fragment() {
    ...
    private val questions = listOf(
        Question("Which loop guarantees at least one execution even if the condition is false?", listOf("for loop", "while loop", "do while loop", "for of loop"), 3),
        Question("What does a closure in JavaScript provide?", listOf("Inheritance", "Access to outer function scope", "Faster execution", "Type safety"), 2),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module2_js, container, false)
    }

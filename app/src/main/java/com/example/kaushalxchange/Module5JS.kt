...
class Module5JS : Fragment() {
    ...
    private val questions = listOf(
        Question("Which method selects the first matching element in the DOM?", listOf("getElementById", "getElementsByClassName", "querySelector", "querySelectorAll"), 3),
        Question("Which storage method keeps data even after closing the browser?", listOf("SessionStorage", "LocalStorage", "Cookies", "Cache"), 2),
        )
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module5_js, container, false)
    }

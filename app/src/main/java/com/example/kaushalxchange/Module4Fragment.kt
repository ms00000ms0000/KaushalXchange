...
class Module4Fragment : Fragment() {
    ...
    private val questions = listOf(
        Question("Which keyword is used to define a function in Python?",
            listOf("func", "function", "def", "define"), 2),

        Question("What is essential in a recursive function to prevent infinite calls?",
            listOf("Loop", "Base case", "Global variable", "Return 0"), 1)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module4_fragment, container, false)
    }

...
class Module2Css : Fragment() {
    ...
    private val questions = listOf(
        Question("Which part of the CSS box model adds space outside the border", listOf("padding", "margin", "content", "outline"), 1),
        Question("Which CSS property is commonly used to change the layout type of an element", listOf("layout", "display", "position", "float"), 1),
        )
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module2_css, container, false)
    }

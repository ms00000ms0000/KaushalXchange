...
class Module6JS : Fragment() {
    ...
    private val questions = listOf(
        Question("Which mechanism allows objects in JavaScript to inherit properties and methods?", listOf("Polymorphism", "Encapsulation", "Prototypes", "Closures"), 3),
        Question("Which method permanently binds a function to a specific object?", listOf("call", "apply", "bind", "assign"), 3),
        Question("Which design pattern is commonly used for implementing a notification system?", listOf("Factory", "Observer", "Singleton", "Decorator"), 2),
        )
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.activity_module6_js, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        startAssignmentBtn.setOnClickListener {
            startActivity(Intent(requireContext(), AssessmentActivityJS::class.java))
        }
    }
